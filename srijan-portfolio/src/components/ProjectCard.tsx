...
import React from 'react';
import { Github, Globe, ExternalLink, Code2, Link, Eye, Telescope } from 'lucide-react';
...
const ProjectCard = ({ title, description, liveDemo, sourceCode }: ProjectCardProps) => {
  return (
    ...
    <div className="group relative w-[290px] h-[300px] [perspective:1000px] mx-auto">
      ...
      <div className="relative h-full w-full rounded-[50px] bg-gradient-to-br from-[rgb(0,255,214)] to-[rgb(8,226,96)] transition-all duration-500 ease-in-out [transform-style:preserve-3d] 
        ...
        {/* 3. Text Content */}
        <div className="relative z-10 p-8 pt-[100px] [transform:translate3d(0,0,26px)]">
        ...
        <div className="absolute p-2 bottom-5 left-6 right-5 flex items-center justify-between [transform-style:preserve-3d] [transform:translate3d(0,0,26px)]">
