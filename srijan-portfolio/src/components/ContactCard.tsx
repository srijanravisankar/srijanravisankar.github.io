...
//   return (
//     <div className="group relative w-[320px] h-[220px] mx-auto">
//       {/* Outer Card Container */}
//       <div className="relative w-full h-full bg-[#1a1f22] border border-white/5 rounded-xl overflow-hidden transition-all duration-500 ease-in-out group-hover:rounded-none group-hover:scale-110 shadow-2xl flex items-center justify-center">
...
//         {/* Logo and Sliding Text Content */}
//         <div className="relative flex items-center justify-center transition-all duration-500">
//           <div className="flex items-center h-[40px] w-[40px] overflow-hidden transition-all duration-1000 ease-in-out group-hover:w-[160px]">
//             {/* SR Logo (Fixed SVG) */}
//             <div className="shrink-0 w-[40px] h-[40px] flex items-center justify-center">
//               <svg viewBox="0 0 60 60" className="h-10 w-10">
//                 {/* S */}
//                 <text x="10" y="40" fontSize="32" fontWeight="bold" fill="#bd9f67" fontFamily="Arial, sans-serif">S</text>
//                 {/* R */}
//                 <text x="35" y="40" fontSize="32" fontWeight="bold" fill="#bd9f67" fontFamily="Arial, sans-serif">R</text>
//               </svg>
//             </div>
//             {/* Sliding Text (Srijan R) */}
//             <span className="whitespace-nowrap ml-3 text-[#bd9f67] font-bold tracking-[0.15em] uppercase text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-300">
//               Srijan
//             </span>
//           </div>
//         </div>

//         {/* Bottom Contact Detail Reveal */}
//         <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500 delay-500">
//           <span className="text-[10px] uppercase tracking-widest text-[#bd9f67] whitespace-nowrap">
